...
public class Validacion {
	...
	public boolean validarNotas(String nombre) {
		boolean control = true;
	...
	public boolean validarLibro(Libro libro) {
		boolean control = false;
			...
			if(validarNombre(libro.getTitulo())&&validarEditorial(libro.getEditorial())&&
			validarPaginas(libro.getPaginas())&&validarAltura(libro.getAltura())&&
			validarNotas(libro.getNotas())&&validarIsbn(libro.getIsbn())&&
